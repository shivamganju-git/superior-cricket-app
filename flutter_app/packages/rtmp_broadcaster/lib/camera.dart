...
class CameraController extends ValueNotifier<CameraValue> {
  ...
  /// Sets an overlay image on the stream.
  /// 
  /// The [imageBytes] should be a PNG or JPEG image.
  /// [textureId] is used to identify the camera instance.
  Future<void> setOverlay(Uint8List imageBytes) async {
    ...
    try {
      ...
      print('Error setting overlay: ${e.message}');
    }
  }
